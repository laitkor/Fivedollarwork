<?php /*$this->set('title_for_layout', '');*/?><h3 class="blog-title"><a href="#" title="Profile Settings"><?php echo $allgigs[0]['Category']['name'] ?></a></h3>
				 ...
				 <table cellspacing="0" cellpadding="0"  class="payment" width="100%">
                        <tbody>
                            ...
                            <td class="row"><a href="/gigs/index" style="background-color: #a6ba76; color:#000"><b>Auto</b></a></td>
                            ...
                            <td class="row"><a href="/gigs/latest" style="color:#FFF">Latest</a></td>
                             <td class="row" align="right" style="width:25%">Job Price:<select name="data[price]" onchange="getPrice(this.value)">
	...
	if(count($allgigs)>0)
		{ //echo "<pre>";print_r($allUser);
            ...
            <table width="100%">
            <tr>
            <td colspan="4"><h4 class="blog-title">
    	  ...
    	  { 
			echo $html->link($html->image('/images/unlike.png'),array('action' => 'like',
			 $gigs['Gig']['id']),array( 'update' => 'post','escape'=>false,'title'=>'Unlike')); 
              ...
              <td align="right"><input type="button" class="broap" value="Order"  id="<?php echo $gigs['Gig']['id']; ?>" onclick="return order(this.id);"  /></tr>
            
            </table>&nbsp;</td>
			
			
		</tr>		</tr></tr><tr><td colspan="2"><hr class="break"  /></td></tr>
		 <?php } 
		}
?>
<tr><td colspan="2">
