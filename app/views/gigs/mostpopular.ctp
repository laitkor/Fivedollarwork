<?php /*$this->set('title_for_layout', '');*/?><!--<h3 class="blog-title"><a href="#" title="Profile Settings">Gigs</a></h3>
				 ...
				 <table cellspacing="0" cellpadding="0"  class="payment" width="100%">
                        <tbody>
							...
							<td class="row" style="background-color: #A6BA76;  color: #000; ">
                            <a href="/gigs/mostpopular"><b>Most Popular</b></a></td>
	...
	if(count($allgigs)>0)
		{ //echo "<pre>";print_r($allUser);
			...
			<td>
            <table width="100%"><tr><td colspan="4"><h4 class="blog-title"><a href="ordergig/<?php echo $gigs['Gig']['id'] ?>">I Will <?php echo $gigs['Gig']['title'];?> for $<?php echo $gigs['Gig']['price'];?></a></h4></td></tr>
