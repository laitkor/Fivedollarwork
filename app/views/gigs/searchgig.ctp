<?php /*$this->set('title_for_layout', '5$ Work');*/?><!--<h3 class="blog-title"><a href="#" title="Profile Settings">5$ Work</a></h3>-->
					...
					<div style="background-color:#CCC; font-size:16px"><b>Search Results For <?php echo $search; ?></b></div></br>
      <?php 
...
<?php /* echo $paginator->first('<< First', true);?>
<?php echo $paginator->prev('<< Previous', true, array(), null, array('class'=>'disabled'));?>
|     <?php echo $paginator->numbers();?> |
<?php echo $paginator->next(' Next >>', true, array(), null, array('class'=>'disabled'));?>
<?php echo $paginator->last('Last >>', true);*/?>
