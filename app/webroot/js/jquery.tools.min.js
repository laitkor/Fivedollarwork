...
$.tools.validator.fn("[data-equals]", "Value not equal with the Password field", function(input) {
...
$.tools.validator.fn("[minlengthvalue]", function(textarea, value) {
	var maxvalue = textarea.attr("minlengthvalue");
	return value.length <= maxvalue ? true : {     
		en: "Please enter a value smaller than " + maxvalue + " character" + (maxvalue > 1 ? "s" : ""),
		fi: "Kentän minimipituus on " +maxvalue+ " merkkiä" 
	};
});

// Regular Expression to test upload file extension valid
$.tools.validator.fn("[accept]", "Please enter a value with a valid extension.", function(input, value) { 
var param =input.attr("accept");
if(value=="")
{
return true;
}
...
{
result=value.match(new RegExp(".(" + param + ")$", "i")); 
if(result==null)
{
return false;
}
